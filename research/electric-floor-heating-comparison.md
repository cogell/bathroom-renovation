...
2. **Thermal Break Benefits** (Reduced value in this context)
   ...
   - Primary benefit is faster heat-up over _concrete_ slabs
   - We have _wood_ subfloor over basement
...
- **Context matters**: This is comparing to systems _without_ thermal break over _concrete_
...
- 4 hours/day operation ≈ $2-3/month (at $0.13/kWh)
...
- Actual heated area ≈ 27 sq ft or less
...
_Note: Add $150-250 for thermostat (same for all systems), can choose any brand_
